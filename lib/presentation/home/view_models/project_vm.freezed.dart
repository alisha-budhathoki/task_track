...
class _$ProjectVMImpl implements _ProjectVM {
  ...
  @override
  String toString() {
    return 'ProjectVM(id: $id, parentId: $parentId, order: $order, color: $color, name: $name, commentCount: $commentCount, isShared: $isShared, isFavorite: $isFavorite, isInboxProject: $isInboxProject, isTeamInbox: $isTeamInbox, url: $url, viewStyle: $viewStyle)';
  }
