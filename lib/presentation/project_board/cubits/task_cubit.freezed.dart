...
mixin _$TaskState {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(List<Task> task) success,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(List<Task> task)? success,
...
class _$SuccessImpl implements _Success {
  const _$SuccessImpl(final List<Task> task) : _task = task;
  ...
  @override
  String toString() {
    return 'TaskState.success(task: $task)';
  }
...
abstract class _Success implements TaskState {
  const factory _Success(final List<Task> task) = _$SuccessImpl;
